                    ...
                    >
                        ...
                        >
                            <div class="posts_count w-5 text-left">
                                <span
                                    class="text-slate-700 text-2xl font-medium"
                                    >{{ index + 1 }}</span
                                >
                            </div>
                            <div class="flex space-x-2">
                                ...
                                <div
                                    class="posts_content my-2 flex flex-col space-y-1"
                                >
                                    ...
                                    <div
                                        class="font-normal text-xs text-[var(--cl-yellow)]"
                                    >
