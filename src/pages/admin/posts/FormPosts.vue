            ...
            <form @submit.prevent="handleSave">
                ...
                <div class="w-full mb-6">
                    ...
                    <input
                        ...
                        placeholder="Aa"
                    />
                    <div v-if="error.title" class="text_error">
                        {{ error.title }}
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input
                        ...
                        placeholder="Số 123"
                    />
                    <div v-if="error.address" class="text_error">
                        {{ error.address }}
                    </div>
                </div>
                <div class="grid gap-6 mb-6 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            :disabled="
                                !posts.province || keyLocation === 'view'
                            "
                        >
                    ...
                    <div>
                        ...
                        <select
                            ...
                            :disabled="
                                !posts.district || keyLocation === 'view'
                            "
                        >
                        ...
                        <div v-if="error.ward" class="text_error">
                            {{ error.ward }}
                        </div>
                    </div>
                </div>
